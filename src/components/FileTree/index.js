...
export default class FileTree extends React.Component {
  ...
  render() {
    ...
    const isVisible = this.props.isVisible ? this.props.isVisible : [];
            ...
            return file.isDirectory ?
              <li className="_directory" key={filePath + ' Directory'} style={directoryStyle}>
                <div onClick={() => this.handleDirectoryClick(file)}>
                  <Directory className="directory" visible={isVisible[file.filePath]} theme={this.props.directoryTheme} />{`               ${fileName}`}
                </div>
                {isVisible[file.filePath] &&
                  <FileTree
